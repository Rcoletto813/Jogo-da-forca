import random
import time
palavras = ['mesa', 'livro', 'tabule','abacate','hamburger', 'celular', 'telescopio', 'computador']
...
print("JOGO DA FORCA!")
print('='*20)
print("Ola eu sou um computador de jogo da forca! Vamos jogar?")
...
while True:
    ...
    if letra in palavra_secreta: #apartir dessa linha
        ...
        print("Voce acertou uma letra nas posições {}".format(', '.join(map(str, posicoes)))) #map converte para qualquer coisa
        print(' '.join(palpites))
